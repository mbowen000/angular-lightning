...
describe('A Form...', function() {
	...
	beforeEach(module('templates','testapp.form'));
	...
	it('should not render fields that are not specified as visible', function() {
		...
		// label
		expect(angular.element(form)[0].querySelectorAll('.smb-field-label').length).toEqual(3);

		// input container
		expect(angular.element(form)[0].querySelectorAll('.smb-field-wrap-main').length).toEqual(3);
